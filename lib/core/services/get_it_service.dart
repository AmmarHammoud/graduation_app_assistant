...
setupSingltonGetIt() async {
  ...
  getIt.registerLazySingleton<ProjectRemoteDataSource>(
        () => ProjectRemoteDataSourceImpl(databaseService: getIt.get<DatabaseService>()),
  );

  // 2. Repository Implementation
  getIt.registerLazySingleton<ProjectRepository>(
        () => ProjectRepositoryImpl(remoteDataSource: getIt.get<ProjectRemoteDataSource>()),
  );
  ...
  getIt.registerFactory(() => ProjectCubit(getProjects: getIt.get<GetProjects>()));
